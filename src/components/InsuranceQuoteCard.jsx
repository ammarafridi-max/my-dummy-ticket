export default function InsuranceQuoteCard({ quote, onClick, isSelected = false }) {
  ...
  return (
    <>
      <div
        className={`md:min-w-auto bg-white rounded-3xl p-6 border shadow-sm hover:shadow-md transition-shadow duration-300 mb-2 ${isSelected ? 'border-primary-500' : 'border-gray-200'}`}
      >
