...
export default function TicketForm() {
  ...
  const handleForm = (e) => {
    e.preventDefault();
    if (!email || !number.code || !number.digits || !from || !to || !departureDate) {
    ...
    <form className={styles.Form} onSubmit={handleForm}>
      <div className={styles.Row}>
        <div className="row">
          ...
          >
            <FaCircle className={`${styles.DotIcon} ${type === 'One Way' && styles.Active}`} />
            One Way
          </p>
          ...
          >
            <FaCircle className={`${styles.DotIcon} ${type === 'Return' && styles.Active}`} />
            Return
          </p>
        </div>
      </div>
      ...
      <div className="row">
        <div className={styles.Input}>
          ...
          <SelectAirport icon={<FaPlaneDeparture />} value={from} onChange={setFrom} />
        </div>
        <div className={styles.Input}>
          <Label htmlFor="to" required>
            To
          </Label>
          <SelectAirport icon={<FaPlaneArrival />} value={to} onChange={setTo} />
        </div>
      </div>
      ...
      <div className="row">
        ...
        <div className={styles.Input}>
          ...
          <Number
            ...
            digitsOnChange={(e) => setNumber({ ...number, digits: e.target.value })}
          />
        </div>
      </div>
      ...
      <div className="row">
        <div className={styles.TextArea}>
          ...
          <TextArea value={message} placeholder="Special requests" onChange={setMessage} />
        </div>
      </div>
        ...
        {formState === 'Active' && (
          <PrimaryButton type="submit">
            ...
            <span className={styles.Total}>
              (AED {price * (quantity.adults + quantity.children + quantity.infants)})
            </span>
          </PrimaryButton>
        )}
        {formState === 'Loading' && (
