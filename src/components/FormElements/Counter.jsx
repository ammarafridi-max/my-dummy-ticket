...
export default function Counter({ ageGroup, age, onAdd, onSubtract, value }) {
  return (
    <div className="w-full flex items-center mt-5 md:w-[33%] md:block md:mt-1">
      <div className="w-[55%] md:w-full text-left md:text-center text-[15px]  p-0 m-0 mb-1.25 font-light font-nunito">
        {ageGroup}
        <span className="text-gray-400 font-light text-[13px] ml-1">{age}</span>
      </div>
      <div className="w-[45%] md:w-full flex justify-between items-center py-2.5 px-3 bg-white rounded-md border border-gray-300">
        <IoIosRemove onClick={onSubtract} className="text-[20px] cursor-pointer" />
